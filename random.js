...
async function download_file(downloadPath,id){
    ...
    headers: {
        ...
        "cookie": "central_production_session_id=a01453dce415a833ec24f2643faa1034; return_to=https://datalink.miovision.com/studies?end_date=2023-09-30&start_date=2023-09-01; intercom-device-id-mi3ti0da=3fd9cefa-c2a6-4b36-8774-30be6acd47a0; intercom-session-mi3ti0da=TXBVR3lWTmErNFRtWWFhTEZSYy93SGJacVNFMVlIaVJiR2ZtblRadWxyYXF5NC9RSXc4UThCS3lYVnQ1SnVHLy0tRmg5UFhvWExvbVV2ejhjVGJtMndXZz09--c5a252b23a20dd34264913de39638c846f16f6e8; download_token_1727916324=1727916324",
...
async function extract_files(start_date,end_date){
    ...
    for (let i = 0;i < raw_dates.length;i++){
        ...
        const path = `${base_folder}/${year}/${monthMapping[month]}/${day_num}/${ids[i]}.xlsx`
        paths.push(path)
    }
...
async function main(){
    ...
    while (start_year <= end_year){
        for(let i = 1;i <= 12;i++){
            ...
            await extract_files(start_date,end_date)
        }
        start_year += 1
    }
